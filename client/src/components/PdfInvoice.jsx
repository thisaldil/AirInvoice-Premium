          ...
          <View style={styles.infoBlock}>
            {Array.isArray(invoiceData?.passengerName) && invoiceData.passengerName.length > 0 ? (
              ...
              <View style={styles.passengerBlock}>
                <Text style={styles.passengerName}>{invoiceData.passengerName}</Text>
                <Text style={styles.passengerDetail}>Email: {invoiceData.email || '--'}</Text>
                <Text style={styles.passengerDetail}>Phone: {invoiceData.phone || '--'}</Text>
                <Text style={styles.passengerDetail}>Address: {invoiceData.address || '--'}</Text>
              </View>
            ) : (
        ...
        <View style={styles.section}>
          ...
          <View style={styles.pricingRow}>
            ...
            <Text style={styles.pricingValue}>
              {invoiceData?.currency || "LKR"} {invoiceData?.totalAmount || "--"}
            </Text>
          </View>
          {invoiceData?.type !== "quotation" && (
            <>
